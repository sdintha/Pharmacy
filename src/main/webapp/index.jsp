...
<%if(request.getAttribute("order")!=null)
  ...
  <tr align="justify">
    ...
    <td valign="top">
        ...
        <h1>Drug Store</h1>
      <p>Anyone can use these HTMLs just by replacing the content to the pre-existing site designs.</p>
        <p align="right"><a href="#" class="more">View More</a></p>
    </td>
    <td valign="top">
...
<div id="footer">
  <div id="footer_1">
    ...
    <span id="design">Designed by <a id="dum" href="http://www.x.com" target="_blank">www.x.com</a></span>
    <script type="text/javascript">
